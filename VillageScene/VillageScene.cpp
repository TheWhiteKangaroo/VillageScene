...
<CodeBlocks_project_file>
	...
	<Project>
		<Option title="VillageScene" />
		<Option pch_mode="2" />
		<Option compiler="gcc" />
		<Build>
			<Target title="Debug">
				<Option output="bin/Debug/VillageScene" prefix_auto="1" extension_auto="1" />
			...
			<Target title="Release">
				<Option output="bin/Release/VillageScene" prefix_auto="1" extension_auto="1" />
				<Option working_dir="C:/Program Files (x86)/CodeBlocks/MinGW/bin" />
